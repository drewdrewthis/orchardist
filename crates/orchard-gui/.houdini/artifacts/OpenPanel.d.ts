...
export type OpenPanel = {
    readonly "input": OpenPanel$input;
    readonly "result": OpenPanel$result | undefined;
};

export type OpenPanel$result = {
    /**
...
export type OpenPanel$input = {
    paneIds?: (string)[] | null | undefined;
};

export type OpenPanel$artifact = {
    "name": "OpenPanel";
    "kind": "HoudiniQuery";
