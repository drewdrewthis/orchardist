...
export type RecentLens = {
    readonly "input": RecentLens$input;
    readonly "result": RecentLens$result | undefined;
};

export type RecentLens$result = {
    /**
...
export type RecentLens$input = null;

export type RecentLens$artifact = {
    "name": "RecentLens";
    "kind": "HoudiniQuery";
    "hash": "9819e915f2ebf8502ac7dc8e5499665b0a80a7287253392a9beb9e85bd6e4e4c";
    "raw": `query RecentLens {
  conversations {
    id
    sessionUuid
    agentName
