...
export type AttentionLens = {
    readonly "input": AttentionLens$input;
    readonly "result": AttentionLens$result | undefined;
};

export type AttentionLens$result = {
    /**
...
export type AttentionLens$input = null;

export type AttentionLens$artifact = {
    "name": "AttentionLens";
    "kind": "HoudiniQuery";
    "hash": "fe9c4097ae59ee527ea5b13d7df91dcda813c324c4b082daef7ab8a06fac05fa";
    "raw": `query AttentionLens {
  workView {
    repos {
      id
      slug
