...
export type IssueLens = {
    readonly "input": IssueLens$input;
    readonly "result": IssueLens$result | undefined;
};

export type IssueLens$result = {
    /**
...
export type IssueLens$input = null;

export type IssueLens$artifact = {
    "name": "IssueLens";
    "kind": "HoudiniQuery";
