...
export type TmuxLens = {
    readonly "input": TmuxLens$input;
    readonly "result": TmuxLens$result | undefined;
};

export type TmuxLens$result = {
    /**
...
export type TmuxLens$input = null;

export type TmuxLens$artifact = {
    "name": "TmuxLens";
    "kind": "HoudiniQuery";
