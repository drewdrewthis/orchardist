...
func (r *mutationResolver) ServiceStart(ctx context.Context, input graphql1.ServiceLifecycleInput) (*graphql1.HostService, error) {
	panic(fmt.Errorf("not implemented: ServiceStart - serviceStart"))
}

// ServiceStop is the resolver for the serviceStop field.
func (r *mutationResolver) ServiceStop(ctx context.Context, input graphql1.ServiceLifecycleInput) (*graphql1.HostService, error) {
	panic(fmt.Errorf("not implemented: ServiceStop - serviceStop"))
}

// ServiceRestart is the resolver for the serviceRestart field.
func (r *mutationResolver) ServiceRestart(ctx context.Context, input graphql1.ServiceLifecycleInput) (*graphql1.HostService, error) {
	panic(fmt.Errorf("not implemented: ServiceRestart - serviceRestart"))
}
...
// HostServiceChanged is the resolver for the hostServiceChanged field.
func (r *subscriptionResolver) HostServiceChanged(ctx context.Context) (<-chan *graphql1.HostService, error) {
	panic(fmt.Errorf("not implemented: HostServiceChanged - hostServiceChanged"))
}
