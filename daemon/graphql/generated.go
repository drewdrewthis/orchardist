...
type ComplexityRoot struct {
	...
	Conversation struct {
		...
		LiveInstances func(childComplexity int) int
	...
	Mutation struct {
		DaemonReload   func(childComplexity int) int
		SendTextToPane func(childComplexity int, paneID string, text string) int
		ServiceRestart func(childComplexity int, input ServiceLifecycleInput) int
		ServiceStart   func(childComplexity int, input ServiceLifecycleInput) int
		ServiceStop    func(childComplexity int, input ServiceLifecycleInput) int
	}
	...
	Query struct {
		...
		ClaudeCli        func(childComplexity int, tool ClaudeCliTool, args []string) int
		...
		Git              func(childComplexity int, worktreeID string, args []string) int
		Health           func(childComplexity int) int
		Host             func(childComplexity int) int
		HostServiceCtl   func(childComplexity int, host string, args []string) int
		...
		Peers            func(childComplexity int) int
		Ps               func(childComplexity int, tool PsTool, args []string) int
		...
		Tmux             func(childComplexity int, args []string) int
	...
	Subscription struct {
		...
		HostServiceChanged  func(childComplexity int) int
...
type MutationResolver interface {
	DaemonReload(ctx context.Context) (*DaemonState, error)
	ServiceStart(ctx context.Context, input ServiceLifecycleInput) (*HostService, error)
	ServiceStop(ctx context.Context, input ServiceLifecycleInput) (*HostService, error)
	ServiceRestart(ctx context.Context, input ServiceLifecycleInput) (*HostService, error)
...
type QueryResolver interface {
	...
	ClaudeCli(ctx context.Context, tool ClaudeCliTool, args []string) (any, error)
	...
	Git(ctx context.Context, worktreeID string, args []string) (any, error)
	...
	HostServiceCtl(ctx context.Context, host string, args []string) (any, error)
	Ps(ctx context.Context, tool PsTool, args []string) (any, error)
	...
	Tmux(ctx context.Context, args []string) (any, error)
...
type SubscriptionResolver interface {
	...
	HostServiceChanged(ctx context.Context) (<-chan *HostService, error)
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Conversation.liveInstances":
		if e.ComplexityRoot.Conversation.LiveInstances == nil {
			break
		}

		return e.ComplexityRoot.Conversation.LiveInstances(childComplexity), true
	...
	case "Mutation.daemonReload":
		if e.ComplexityRoot.Mutation.DaemonReload == nil {
			break
		}

		return e.ComplexityRoot.Mutation.DaemonReload(childComplexity), true
	...
	case "Mutation.serviceRestart":
		...
		return e.ComplexityRoot.Mutation.ServiceRestart(childComplexity, args["input"].(ServiceLifecycleInput)), true
	case "Mutation.serviceStart":
		...
		return e.ComplexityRoot.Mutation.ServiceStart(childComplexity, args["input"].(ServiceLifecycleInput)), true
	case "Mutation.serviceStop":
		...
		return e.ComplexityRoot.Mutation.ServiceStop(childComplexity, args["input"].(ServiceLifecycleInput)), true
	...
	case "Query.claudeCli":
		if e.ComplexityRoot.Query.ClaudeCli == nil {
			break
		}

		args, err := ec.field_Query_claudeCli_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Query.ClaudeCli(childComplexity, args["tool"].(ClaudeCliTool), args["args"].([]string)), true
	...
	case "Query.git":
		if e.ComplexityRoot.Query.Git == nil {
			break
		}

		args, err := ec.field_Query_git_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Query.Git(childComplexity, args["worktreeId"].(string), args["args"].([]string)), true
	case "Query.health":
	...
	case "Query.hostServiceCtl":
		if e.ComplexityRoot.Query.HostServiceCtl == nil {
			break
		}

		args, err := ec.field_Query_hostServiceCtl_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Query.HostServiceCtl(childComplexity, args["host"].(string), args["args"].([]string)), true
	...
	case "Query.ps":
		if e.ComplexityRoot.Query.Ps == nil {
			break
		}

		args, err := ec.field_Query_ps_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Query.Ps(childComplexity, args["tool"].(PsTool), args["args"].([]string)), true
	...
	case "Query.tmux":
		if e.ComplexityRoot.Query.Tmux == nil {
			break
		}

		args, err := ec.field_Query_tmux_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}

		return e.ComplexityRoot.Query.Tmux(childComplexity, args["args"].([]string)), true
	...
	case "Subscription.hostServiceChanged":
		if e.ComplexityRoot.Subscription.HostServiceChanged == nil {
			break
		}

		return e.ComplexityRoot.Subscription.HostServiceChanged(childComplexity), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		...
		ec.unmarshalInputServiceLifecycleInput,
...
var sources = []*ast.Source{
	{Name: "../schema.graphql", Input: `# Root schema — shared interface, scalars, and the empty root operation
...
type Subscription
`, BuiltIn: false},
	{Name: "../claude-account/schema.graphql", Input: `# claude-account — ` + "`" + `claude auth status` + "`" + ` + ccusage quota scraping.
#
# Owns: ClaudeAccount.
...
`, BuiltIn: false},
	{Name: "../claude-instance/schema.graphql", Input: `# claude-instance — live Claude REPL derived from jsonl-tail + matching pane process.
#
...
`, BuiltIn: false},
	{Name: "../claude-jsonls/schema.graphql", Input: `# claude-jsonls — raw record parsing of Claude Code session JSONLs.
#
# Owns: Conversation.
...
#   - ` + "`" + `contracts` + "`" + `: parses the Contracts-plugin records that ride on the
#     same JSONL stream
...
is metadata + a single live signal (` + "`" + `open` + "`" + `) and an optional plugin-populated
` + "`" + `recap` + "`" + `. For transcript bodies see ` + "`" + `GET /v1/conversations/<sessionUuid>/jsonl` + "`" + `.
...
`, BuiltIn: false},
	{Name: "../contracts/schema.graphql", Input: `# contracts — agent delivery commitments parsed from the Contracts plugin's records.
#
...
`, BuiltIn: false},
	{Name: "../daemon-meta/schema.graphql", Input: `# daemon-meta — provider freshness counters + per-field provenance envelope.
#
...
`, BuiltIn: false},
	{Name: "../daemon-self/schema.graphql", Input: `# daemon-self — daemon liveness, version, schema bytes, node-id dispatcher.
#
# Owns: Health.
# Owns: Query.{health, version, schemaSDL, node}.
#
# Health-of-providers + freshness counters live in ` + "`" + `daemon-meta` + "`" + `.
# The composite workView lives in ` + "`" + `views` + "`" + `.
...
`, BuiltIn: false},
	{Name: "../gh/schema.graphql", Input: `# gh — GitHub API: repos (github view), issues, pull requests, workflow runs.
#
...
`, BuiltIn: false},
	{Name: "../git/schema.graphql", Input: `# git — local git repos: worktrees, branches, refs, status, ahead/behind.
#
# Owns: Repo, Worktree.
...
`, BuiltIn: false},
	{Name: "../host-identity/schema.graphql", Input: `# host-identity — machine identity + resource load.
#
...
`, BuiltIn: false},
	{Name: "../host-services/schema.graphql", Input: `# host-services — launchd/systemd unit watchlist.
#
...
`, BuiltIn: false},
	{Name: "../ps/schema.graphql", Input: `# ps — OS process table.
#
...
`, BuiltIn: false},
	{Name: "../tmux/schema.graphql", Input: `# tmux — tmux server: sessions, windows, panes, clients.
#
...
`, BuiltIn: false},
	{Name: "../views/schema.graphql", Input: `# views — composite views that traverse multiple domains for round-trip economy.
#
# Owns: WorkView.
# Owns: Query.workView.
#
...
func (ec *executionContext) childFields_Conversation(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	...
	case "liveInstances":
		return ec.fieldContext_Conversation_liveInstances(ctx, field)
	}
...
func (ec *executionContext) field_Host_processes_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "filter",
		func(ctx context.Context, v any) (*ProcessFilter, error) {
			return ec.unmarshalOProcessFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProcessFilter(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_serviceRestart_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input",
		func(ctx context.Context, v any) (ServiceLifecycleInput, error) {
			return ec.unmarshalNServiceLifecycleInput2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐServiceLifecycleInput(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Query_claudeCli_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "tool",
		func(ctx context.Context, v any) (ClaudeCliTool, error) {
			return ec.unmarshalNClaudeCliTool2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeCliTool(ctx, v)
		})
	if err != nil {
		return nil, err
	}
	args["tool"] = arg0
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "args",
		func(ctx context.Context, v any) ([]string, error) {
...
func (ec *executionContext) field_Query_contracts_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "filter",
		func(ctx context.Context, v any) (*ContractFilter, error) {
			return ec.unmarshalOContractFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractFilter(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Query_git_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "worktreeId",
		func(ctx context.Context, v any) (string, error) {
			return ec.unmarshalNID2string(ctx, v)
		})
	if err != nil {
...
func (ec *executionContext) field_Query_hostServiceCtl_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
...
func (ec *executionContext) field_Query_hostServices_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "filter",
		func(ctx context.Context, v any) (*HostServiceFilter, error) {
			return ec.unmarshalOHostServiceFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceFilter(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Query_issues_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "state",
		func(ctx context.Context, v any) (*IssueState, error) {
			return ec.unmarshalOIssueState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueState(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Query_ps_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "tool",
		func(ctx context.Context, v any) (PsTool, error) {
			return ec.unmarshalNPsTool2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPsTool(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Query_pullRequests_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg1, err := graphql.ProcessArgField(ctx, rawArgs, "state",
		func(ctx context.Context, v any) (*PullRequestState, error) {
			return ec.unmarshalOPullRequestState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestState(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Query_tmuxPanes_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "filter",
		func(ctx context.Context, v any) (*TmuxPaneFilter, error) {
			return ec.unmarshalOTmuxPaneFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxPaneFilter(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Query_tmuxSessions_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "filter",
		func(ctx context.Context, v any) (*TmuxSessionFilter, error) {
			return ec.unmarshalOTmuxSessionFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSessionFilter(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Query_tmux_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "args",
		func(ctx context.Context, v any) ([]string, error) {
			return ec.unmarshalNString2ᚕstringᚄ(ctx, v)
		})
	if err != nil {
...
func (ec *executionContext) field_TmuxServer_sessions_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "sort",
		func(ctx context.Context, v any) (*TmuxSessionSort, error) {
			return ec.unmarshalOTmuxSessionSort2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSessionSort(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) _ClaudeAccount_host(ctx context.Context, field graphql.CollectedField, obj *ClaudeAccount) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Host) graphql.Marshaler {
			return ec.marshalNHost2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHost(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _ClaudeAccount_instances(ctx context.Context, field graphql.CollectedField, obj *ClaudeAccount) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*ClaudeInstance) graphql.Marshaler {
			return ec.marshalNClaudeInstance2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeInstanceᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _ClaudeInstance_pane(ctx context.Context, field graphql.CollectedField, obj *ClaudeInstance) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *TmuxPane) graphql.Marshaler {
			return ec.marshalOTmuxPane2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxPane(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _ClaudeInstance_process(ctx context.Context, field graphql.CollectedField, obj *ClaudeInstance) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Process) graphql.Marshaler {
			return ec.marshalOProcess2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProcess(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _ClaudeInstance_account(ctx context.Context, field graphql.CollectedField, obj *ClaudeInstance) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *ClaudeAccount) graphql.Marshaler {
			return ec.marshalOClaudeAccount2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeAccount(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _ClaudeInstance_state(ctx context.Context, field graphql.CollectedField, obj *ClaudeInstance) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v InstanceState) graphql.Marshaler {
			return ec.marshalNInstanceState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐInstanceState(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _ClaudeInstance_worktree(ctx context.Context, field graphql.CollectedField, obj *ClaudeInstance) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Worktree) graphql.Marshaler {
			return ec.marshalOWorktree2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorktree(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _ClaudeInstance_conversation(ctx context.Context, field graphql.CollectedField, obj *ClaudeInstance) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Conversation) graphql.Marshaler {
			return ec.marshalOConversation2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐConversation(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Contract_status(ctx context.Context, field graphql.CollectedField, obj *Contract) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v ContractStatus) graphql.Marshaler {
			return ec.marshalNContractStatus2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractStatus(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Contract_openQuestions(ctx context.Context, field graphql.CollectedField, obj *Contract) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*ContractQuestion) graphql.Marshaler {
			return ec.marshalNContractQuestion2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractQuestionᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Conversation_liveInstances(ctx context.Context, field graphql.CollectedField, obj *Conversation) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_Conversation_liveInstances(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Conversation",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) _DaemonState_providers(ctx context.Context, field graphql.CollectedField, obj *DaemonState) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*ProviderHealth) graphql.Marshaler {
			return ec.marshalNProviderHealth2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProviderHealthᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Host_resourceLoad(ctx context.Context, field graphql.CollectedField, obj *Host) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *ResourceLoad) graphql.Marshaler {
			return ec.marshalOResourceLoad2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐResourceLoad(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Host_peers(ctx context.Context, field graphql.CollectedField, obj *Host) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*Host) graphql.Marshaler {
			return ec.marshalNHost2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Host_hostServices(ctx context.Context, field graphql.CollectedField, obj *Host) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*HostService) graphql.Marshaler {
			return ec.marshalNHostService2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Host_processes(ctx context.Context, field graphql.CollectedField, obj *Host) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*Process) graphql.Marshaler {
			return ec.marshalNProcess2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProcessᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _HostService_state(ctx context.Context, field graphql.CollectedField, obj *HostService) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v HostServiceState) graphql.Marshaler {
			return ec.marshalNHostServiceState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceState(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Issue_state(ctx context.Context, field graphql.CollectedField, obj *Issue) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v IssueState) graphql.Marshaler {
			return ec.marshalNIssueState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueState(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Issue_comments(ctx context.Context, field graphql.CollectedField, obj *Issue) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*IssueComment) graphql.Marshaler {
			return ec.marshalOIssueComment2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueCommentᚄ(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Issue_labels(ctx context.Context, field graphql.CollectedField, obj *Issue) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*Label) graphql.Marshaler {
			return ec.marshalNLabel2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐLabelᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Issue_blockedByIssues(ctx context.Context, field graphql.CollectedField, obj *Issue) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*Issue) graphql.Marshaler {
			return ec.marshalNIssue2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Issue_parentIssue(ctx context.Context, field graphql.CollectedField, obj *Issue) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *Issue) graphql.Marshaler {
			return ec.marshalOIssue2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssue(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Mutation_daemonReload(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Mutation_daemonReload(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Mutation().DaemonReload(ctx)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *DaemonState) graphql.Marshaler {
			return ec.marshalNDaemonState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐDaemonState(ctx, selections, v)
		},
		true,
		true,
	)
}
func (ec *executionContext) fieldContext_Mutation_daemonReload(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _Mutation_serviceStart(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().ServiceStart(ctx, fc.Args["input"].(ServiceLifecycleInput))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *HostService) graphql.Marshaler {
			return ec.marshalNHostService2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostService(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Mutation_serviceStop(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().ServiceStop(ctx, fc.Args["input"].(ServiceLifecycleInput))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *HostService) graphql.Marshaler {
			return ec.marshalNHostService2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostService(ctx, selections, v)
...
func (ec *executionContext) _Mutation_serviceRestart(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().ServiceRestart(ctx, fc.Args["input"].(ServiceLifecycleInput))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *HostService) graphql.Marshaler {
			return ec.marshalNHostService2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostService(ctx, selections, v)
...
func (ec *executionContext) _Process_claudeInstance(ctx context.Context, field graphql.CollectedField, obj *Process) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *ClaudeInstance) graphql.Marshaler {
			return ec.marshalOClaudeInstance2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeInstance(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _PullRequest_state(ctx context.Context, field graphql.CollectedField, obj *PullRequest) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v PullRequestState) graphql.Marshaler {
			return ec.marshalNPullRequestState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestState(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _PullRequest_reviews(ctx context.Context, field graphql.CollectedField, obj *PullRequest) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*PullRequestReview) graphql.Marshaler {
			return ec.marshalOPullRequestReview2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestReviewᚄ(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _PullRequest_mergeable(ctx context.Context, field graphql.CollectedField, obj *PullRequest) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v MergeableState) graphql.Marshaler {
			return ec.marshalNMergeableState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐMergeableState(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _PullRequest_reviewDecision(ctx context.Context, field graphql.CollectedField, obj *PullRequest) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *ReviewDecisionEnum) graphql.Marshaler {
			return ec.marshalOReviewDecisionEnum2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐReviewDecisionEnum(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _PullRequest_statusCheckRollup(ctx context.Context, field graphql.CollectedField, obj *PullRequest) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v CiStatus) graphql.Marshaler {
			return ec.marshalNCiStatus2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐCiStatus(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_claudeAccounts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*ClaudeAccount) graphql.Marshaler {
			return ec.marshalNClaudeAccount2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeAccountᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_claudeCli(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_claudeCli(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Query().ClaudeCli(ctx, fc.Args["tool"].(ClaudeCliTool), fc.Args["args"].([]string))
		},
		nil,
...
func (ec *executionContext) fieldContext_Query_claudeCli(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_claudeCli_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Query_conversations(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*Conversation) graphql.Marshaler {
			return ec.marshalNConversation2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐConversationᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_contract(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Contract) graphql.Marshaler {
			return ec.marshalOContract2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContract(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Query_contracts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*Contract) graphql.Marshaler {
			return ec.marshalNContract2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_health(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Health) graphql.Marshaler {
			return ec.marshalNHealth2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHealth(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_node(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v Node) graphql.Marshaler {
			return ec.marshalONode2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐNode(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Query_pullRequests(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*PullRequest) graphql.Marshaler {
			return ec.marshalOPullRequest2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestᚄ(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Query_openPullRequests(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*PullRequest) graphql.Marshaler {
			return ec.marshalNPullRequest2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_issues(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*Issue) graphql.Marshaler {
			return ec.marshalOIssue2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueᚄ(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Query_pullRequest(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *PullRequest) graphql.Marshaler {
			return ec.marshalOPullRequest2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequest(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Query_workflowRuns(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*WorkflowRun) graphql.Marshaler {
			return ec.marshalOWorkflowRun2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorkflowRunᚄ(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Query_repos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*Repo) graphql.Marshaler {
			return ec.marshalNRepo2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐRepoᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_git(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_git(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Query().Git(ctx, fc.Args["worktreeId"].(string), fc.Args["args"].([]string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v any) graphql.Marshaler {
			return ec.marshalOJSON2interface(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Query_git(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_git_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Query_hostServiceCtl(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_hostServiceCtl(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Query().HostServiceCtl(ctx, fc.Args["host"].(string), fc.Args["args"].([]string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v any) graphql.Marshaler {
			return ec.marshalOJSON2interface(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Query_hostServiceCtl(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_hostServiceCtl_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Query_ps(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_ps(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Query().Ps(ctx, fc.Args["tool"].(PsTool), fc.Args["args"].([]string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v any) graphql.Marshaler {
			return ec.marshalOJSON2interface(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Query_ps(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_ps_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Query_tmuxServer(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *TmuxServer) graphql.Marshaler {
			return ec.marshalOTmuxServer2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxServer(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _Query_tmuxSessions(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*TmuxSession) graphql.Marshaler {
			return ec.marshalNTmuxSession2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSessionᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_tmuxPanes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*TmuxPane) graphql.Marshaler {
			return ec.marshalNTmuxPane2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxPaneᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Query_tmux(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_tmux(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Query().Tmux(ctx, fc.Args["args"].([]string))
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v any) graphql.Marshaler {
			return ec.marshalOJSON2interface(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Query_tmux(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_tmux_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Query_workView(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *WorkView) graphql.Marshaler {
			return ec.marshalNWorkView2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorkView(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Repo_worktrees(ctx context.Context, field graphql.CollectedField, obj *Repo) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*Worktree) graphql.Marshaler {
			return ec.marshalNWorktree2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorktreeᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Subscription_nodeChanged(ctx context.Context, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	return graphql.ResolveFieldStream(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v Node) graphql.Marshaler {
			return ec.marshalNNode2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐNode(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Subscription_pullRequestChanged(ctx context.Context, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	return graphql.ResolveFieldStream(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *PullRequest) graphql.Marshaler {
			return ec.marshalNPullRequest2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequest(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Subscription_runChanged(ctx context.Context, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	return graphql.ResolveFieldStream(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *WorkflowRun) graphql.Marshaler {
			return ec.marshalNWorkflowRun2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorkflowRun(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Subscription_hostServiceChanged(ctx context.Context, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	return graphql.ResolveFieldStream(
		ctx,
		ec.OperationContext,
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Subscription_hostServiceChanged(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			return ec.Resolvers.Subscription().HostServiceChanged(ctx)
		},
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *HostService) graphql.Marshaler {
			return ec.marshalNHostService2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostService(ctx, selections, v)
...
func (ec *executionContext) fieldContext_Subscription_hostServiceChanged(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Subscription",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) _TmuxClient_server(ctx context.Context, field graphql.CollectedField, obj *TmuxClient) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *TmuxServer) graphql.Marshaler {
			return ec.marshalNTmuxServer2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxServer(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _TmuxClient_session(ctx context.Context, field graphql.CollectedField, obj *TmuxClient) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *TmuxSession) graphql.Marshaler {
			return ec.marshalNTmuxSession2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSession(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _TmuxClient_currentWindow(ctx context.Context, field graphql.CollectedField, obj *TmuxClient) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *TmuxWindow) graphql.Marshaler {
			return ec.marshalOTmuxWindow2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxWindow(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _TmuxPane_window(ctx context.Context, field graphql.CollectedField, obj *TmuxPane) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *TmuxWindow) graphql.Marshaler {
			return ec.marshalNTmuxWindow2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxWindow(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _TmuxPane_watchingClients(ctx context.Context, field graphql.CollectedField, obj *TmuxPane) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*TmuxClient) graphql.Marshaler {
			return ec.marshalNTmuxClient2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxClientᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _TmuxSession_windows(ctx context.Context, field graphql.CollectedField, obj *TmuxSession) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v []*TmuxWindow) graphql.Marshaler {
			return ec.marshalNTmuxWindow2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxWindowᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _WorkView_meta(ctx context.Context, field graphql.CollectedField, obj *WorkView) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Meta) graphql.Marshaler {
			return ec.marshalNMeta2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐMeta(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Worktree_tmuxSession(ctx context.Context, field graphql.CollectedField, obj *Worktree) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *TmuxSession) graphql.Marshaler {
			return ec.marshalOTmuxSession2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSession(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) unmarshalInputContractFilter(ctx context.Context, obj any) (ContractFilter, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "statuses":
			...
			data, err := ec.unmarshalOContractStatus2ᚕgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractStatusᚄ(ctx, v)
			if err != nil {
				return it, err
			}
			it.Statuses = data
...
func (ec *executionContext) unmarshalInputHostServiceFilter(ctx context.Context, obj any) (HostServiceFilter, error) {
	...
	for _, k := range fieldsInOrder {
		...
		case "state":
			...
			data, err := ec.unmarshalOHostServiceState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceState(ctx, v)
			if err != nil {
				return it, err
			}
			it.State = data
...
func (ec *executionContext) unmarshalInputServiceLifecycleInput(ctx context.Context, obj any) (ServiceLifecycleInput, error) {
	var it ServiceLifecycleInput
	if obj == nil {
		return it, nil
	}
	...
	fieldsInOrder := [...]string{"host", "name"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) _Conversation(ctx context.Context, sel ast.SelectionSet, obj *Conversation) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "liveInstances":
			out.Values[i] = ec._Conversation_liveInstances(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
	...
	for i, field := range fields {
		...
		case "daemonReload":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_daemonReload(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
	...
	for i, field := range fields {
		...
		case "claudeCli":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_claudeCli(ctx, field)
				return res
			}
		...
		case "hostServiceCtl":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query_hostServiceCtl(ctx, field)
				return res
			}
...
func (ec *executionContext) _Subscription(ctx context.Context, sel ast.SelectionSet) func(ctx context.Context) graphql.Marshaler {
	...
	case "hostServiceChanged":
		return ec._Subscription_hostServiceChanged(ctx, fields[0])
	case "processes":
...
func (ec *executionContext) unmarshalNCiStatus2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐCiStatus(ctx context.Context, v any) (CiStatus, error) {
	var res CiStatus
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNCiStatus2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐCiStatus(ctx context.Context, sel ast.SelectionSet, v CiStatus) graphql.Marshaler {
	return v
}

func (ec *executionContext) marshalNClaudeAccount2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeAccountᚄ(ctx context.Context, sel ast.SelectionSet, v []*ClaudeAccount) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNClaudeAccount2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeAccount(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNClaudeAccount2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeAccount(ctx context.Context, sel ast.SelectionSet, v *ClaudeAccount) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNClaudeCliTool2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeCliTool(ctx context.Context, v any) (ClaudeCliTool, error) {
	var res ClaudeCliTool
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNClaudeCliTool2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeCliTool(ctx context.Context, sel ast.SelectionSet, v ClaudeCliTool) graphql.Marshaler {
	return v
}

func (ec *executionContext) marshalNClaudeInstance2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeInstanceᚄ(ctx context.Context, sel ast.SelectionSet, v []*ClaudeInstance) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNClaudeInstance2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeInstance(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNClaudeInstance2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeInstance(ctx context.Context, sel ast.SelectionSet, v *ClaudeInstance) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNContract2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractᚄ(ctx context.Context, sel ast.SelectionSet, v []*Contract) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNContract2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContract(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNContract2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContract(ctx context.Context, sel ast.SelectionSet, v *Contract) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNContractQuestion2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractQuestionᚄ(ctx context.Context, sel ast.SelectionSet, v []*ContractQuestion) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNContractQuestion2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractQuestion(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNContractQuestion2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractQuestion(ctx context.Context, sel ast.SelectionSet, v *ContractQuestion) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNContractStatus2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractStatus(ctx context.Context, v any) (ContractStatus, error) {
	var res ContractStatus
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNContractStatus2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractStatus(ctx context.Context, sel ast.SelectionSet, v ContractStatus) graphql.Marshaler {
	return v
}

func (ec *executionContext) marshalNConversation2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐConversationᚄ(ctx context.Context, sel ast.SelectionSet, v []*Conversation) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNConversation2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐConversation(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNConversation2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐConversation(ctx context.Context, sel ast.SelectionSet, v *Conversation) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNDaemonState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐDaemonState(ctx context.Context, sel ast.SelectionSet, v DaemonState) graphql.Marshaler {
	return ec._DaemonState(ctx, sel, &v)
}

func (ec *executionContext) marshalNDaemonState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐDaemonState(ctx context.Context, sel ast.SelectionSet, v *DaemonState) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNHealth2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHealth(ctx context.Context, sel ast.SelectionSet, v Health) graphql.Marshaler {
	return ec._Health(ctx, sel, &v)
}

func (ec *executionContext) marshalNHealth2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHealth(ctx context.Context, sel ast.SelectionSet, v *Health) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNHost2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHost(ctx context.Context, sel ast.SelectionSet, v Host) graphql.Marshaler {
	return ec._Host(ctx, sel, &v)
}

func (ec *executionContext) marshalNHost2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostᚄ(ctx context.Context, sel ast.SelectionSet, v []*Host) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNHost2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHost(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNHost2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHost(ctx context.Context, sel ast.SelectionSet, v *Host) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNHostService2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostService(ctx context.Context, sel ast.SelectionSet, v HostService) graphql.Marshaler {
	return ec._HostService(ctx, sel, &v)
}

func (ec *executionContext) marshalNHostService2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceᚄ(ctx context.Context, sel ast.SelectionSet, v []*HostService) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNHostService2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostService(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNHostService2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostService(ctx context.Context, sel ast.SelectionSet, v *HostService) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNHostServiceState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceState(ctx context.Context, v any) (HostServiceState, error) {
	var res HostServiceState
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNHostServiceState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceState(ctx context.Context, sel ast.SelectionSet, v HostServiceState) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) unmarshalNInstanceState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐInstanceState(ctx context.Context, v any) (InstanceState, error) {
	var res InstanceState
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNInstanceState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐInstanceState(ctx context.Context, sel ast.SelectionSet, v InstanceState) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) marshalNIssue2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueᚄ(ctx context.Context, sel ast.SelectionSet, v []*Issue) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNIssue2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssue(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNIssue2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssue(ctx context.Context, sel ast.SelectionSet, v *Issue) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNIssueComment2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueComment(ctx context.Context, sel ast.SelectionSet, v *IssueComment) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNIssueState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueState(ctx context.Context, v any) (IssueState, error) {
	var res IssueState
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNIssueState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueState(ctx context.Context, sel ast.SelectionSet, v IssueState) graphql.Marshaler {
	return v
}

func (ec *executionContext) marshalNLabel2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐLabelᚄ(ctx context.Context, sel ast.SelectionSet, v []*Label) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNLabel2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐLabel(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNLabel2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐLabel(ctx context.Context, sel ast.SelectionSet, v *Label) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNMergeableState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐMergeableState(ctx context.Context, v any) (MergeableState, error) {
	var res MergeableState
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNMergeableState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐMergeableState(ctx context.Context, sel ast.SelectionSet, v MergeableState) graphql.Marshaler {
	return v
}

func (ec *executionContext) marshalNMeta2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐMeta(ctx context.Context, sel ast.SelectionSet, v *Meta) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNNode2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐNode(ctx context.Context, sel ast.SelectionSet, v Node) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNProcess2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProcessᚄ(ctx context.Context, sel ast.SelectionSet, v []*Process) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNProcess2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProcess(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNProcess2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProcess(ctx context.Context, sel ast.SelectionSet, v *Process) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNProviderHealth2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProviderHealthᚄ(ctx context.Context, sel ast.SelectionSet, v []*ProviderHealth) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNProviderHealth2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProviderHealth(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNProviderHealth2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProviderHealth(ctx context.Context, sel ast.SelectionSet, v *ProviderHealth) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNPsTool2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPsTool(ctx context.Context, v any) (PsTool, error) {
	var res PsTool
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNPsTool2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPsTool(ctx context.Context, sel ast.SelectionSet, v PsTool) graphql.Marshaler {
	return v
}

func (ec *executionContext) marshalNPullRequest2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequest(ctx context.Context, sel ast.SelectionSet, v PullRequest) graphql.Marshaler {
	return ec._PullRequest(ctx, sel, &v)
}

func (ec *executionContext) marshalNPullRequest2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestᚄ(ctx context.Context, sel ast.SelectionSet, v []*PullRequest) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNPullRequest2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequest(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNPullRequest2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequest(ctx context.Context, sel ast.SelectionSet, v *PullRequest) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNPullRequestReview2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestReview(ctx context.Context, sel ast.SelectionSet, v *PullRequestReview) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNPullRequestState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestState(ctx context.Context, v any) (PullRequestState, error) {
	var res PullRequestState
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNPullRequestState2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestState(ctx context.Context, sel ast.SelectionSet, v PullRequestState) graphql.Marshaler {
	return v
}

func (ec *executionContext) marshalNRepo2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐRepoᚄ(ctx context.Context, sel ast.SelectionSet, v []*Repo) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNRepo2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐRepo(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNRepo2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐRepo(ctx context.Context, sel ast.SelectionSet, v *Repo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNServiceLifecycleInput2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐServiceLifecycleInput(ctx context.Context, v any) (ServiceLifecycleInput, error) {
	res, err := ec.unmarshalInputServiceLifecycleInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}
...
func (ec *executionContext) marshalNTmuxClient2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxClientᚄ(ctx context.Context, sel ast.SelectionSet, v []*TmuxClient) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTmuxClient2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxClient(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTmuxClient2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxClient(ctx context.Context, sel ast.SelectionSet, v *TmuxClient) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNTmuxPane2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxPaneᚄ(ctx context.Context, sel ast.SelectionSet, v []*TmuxPane) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTmuxPane2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxPane(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTmuxPane2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxPane(ctx context.Context, sel ast.SelectionSet, v *TmuxPane) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNTmuxServer2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxServer(ctx context.Context, sel ast.SelectionSet, v TmuxServer) graphql.Marshaler {
	return ec._TmuxServer(ctx, sel, &v)
}

func (ec *executionContext) marshalNTmuxServer2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxServer(ctx context.Context, sel ast.SelectionSet, v *TmuxServer) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNTmuxSession2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSession(ctx context.Context, sel ast.SelectionSet, v TmuxSession) graphql.Marshaler {
	return ec._TmuxSession(ctx, sel, &v)
}

func (ec *executionContext) marshalNTmuxSession2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSessionᚄ(ctx context.Context, sel ast.SelectionSet, v []*TmuxSession) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTmuxSession2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSession(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTmuxSession2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSession(ctx context.Context, sel ast.SelectionSet, v *TmuxSession) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNTmuxWindow2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxWindow(ctx context.Context, sel ast.SelectionSet, v TmuxWindow) graphql.Marshaler {
	return ec._TmuxWindow(ctx, sel, &v)
}

func (ec *executionContext) marshalNTmuxWindow2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxWindowᚄ(ctx context.Context, sel ast.SelectionSet, v []*TmuxWindow) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTmuxWindow2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxWindow(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTmuxWindow2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxWindow(ctx context.Context, sel ast.SelectionSet, v *TmuxWindow) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNWorkView2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorkView(ctx context.Context, sel ast.SelectionSet, v WorkView) graphql.Marshaler {
	return ec._WorkView(ctx, sel, &v)
}

func (ec *executionContext) marshalNWorkView2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorkView(ctx context.Context, sel ast.SelectionSet, v *WorkView) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNWorkflowRun2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorkflowRun(ctx context.Context, sel ast.SelectionSet, v WorkflowRun) graphql.Marshaler {
	return ec._WorkflowRun(ctx, sel, &v)
}

func (ec *executionContext) marshalNWorkflowRun2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorkflowRun(ctx context.Context, sel ast.SelectionSet, v *WorkflowRun) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNWorktree2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorktreeᚄ(ctx context.Context, sel ast.SelectionSet, v []*Worktree) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNWorktree2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorktree(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNWorktree2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorktree(ctx context.Context, sel ast.SelectionSet, v *Worktree) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOClaudeAccount2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeAccount(ctx context.Context, sel ast.SelectionSet, v *ClaudeAccount) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._ClaudeAccount(ctx, sel, v)
...
func (ec *executionContext) marshalOClaudeInstance2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐClaudeInstance(ctx context.Context, sel ast.SelectionSet, v *ClaudeInstance) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._ClaudeInstance(ctx, sel, v)
...
func (ec *executionContext) marshalOContract2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContract(ctx context.Context, sel ast.SelectionSet, v *Contract) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Contract(ctx, sel, v)
...
func (ec *executionContext) unmarshalOContractFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractFilter(ctx context.Context, v any) (*ContractFilter, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) unmarshalOContractStatus2ᚕgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractStatusᚄ(ctx context.Context, v any) ([]ContractStatus, error) {
	if v == nil {
		return nil, nil
	}
	var vSlice []any
	...
	for i := range vSlice {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithIndex(i))
		res[i], err = ec.unmarshalNContractStatus2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractStatus(ctx, vSlice[i])
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) marshalOContractStatus2ᚕgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractStatusᚄ(ctx context.Context, sel ast.SelectionSet, v []ContractStatus) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNContractStatus2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐContractStatus(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalOConversation2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐConversation(ctx context.Context, sel ast.SelectionSet, v *Conversation) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Conversation(ctx, sel, v)
...
func (ec *executionContext) unmarshalOHostServiceFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceFilter(ctx context.Context, v any) (*HostServiceFilter, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) unmarshalOHostServiceState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceState(ctx context.Context, v any) (*HostServiceState, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOHostServiceState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐHostServiceState(ctx context.Context, sel ast.SelectionSet, v *HostServiceState) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
...
func (ec *executionContext) marshalOIssue2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueᚄ(ctx context.Context, sel ast.SelectionSet, v []*Issue) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
...
func (ec *executionContext) marshalOIssue2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssue(ctx context.Context, sel ast.SelectionSet, v *Issue) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Issue(ctx, sel, v)
...
func (ec *executionContext) marshalOIssueComment2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueCommentᚄ(ctx context.Context, sel ast.SelectionSet, v []*IssueComment) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNIssueComment2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueComment(ctx, sel, v[i])
	})
...
func (ec *executionContext) unmarshalOIssueState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueState(ctx context.Context, v any) (*IssueState, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOIssueState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐIssueState(ctx context.Context, sel ast.SelectionSet, v *IssueState) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
...
func (ec *executionContext) marshalONode2githubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐNode(ctx context.Context, sel ast.SelectionSet, v Node) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Node(ctx, sel, v)
...
func (ec *executionContext) marshalOProcess2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProcess(ctx context.Context, sel ast.SelectionSet, v *Process) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Process(ctx, sel, v)
...
func (ec *executionContext) unmarshalOProcessFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐProcessFilter(ctx context.Context, v any) (*ProcessFilter, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOPullRequest2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestᚄ(ctx context.Context, sel ast.SelectionSet, v []*PullRequest) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
...
func (ec *executionContext) marshalOPullRequest2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequest(ctx context.Context, sel ast.SelectionSet, v *PullRequest) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._PullRequest(ctx, sel, v)
...
func (ec *executionContext) marshalOPullRequestReview2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestReviewᚄ(ctx context.Context, sel ast.SelectionSet, v []*PullRequestReview) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNPullRequestReview2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestReview(ctx, sel, v[i])
	})
...
func (ec *executionContext) unmarshalOPullRequestState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestState(ctx context.Context, v any) (*PullRequestState, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOPullRequestState2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐPullRequestState(ctx context.Context, sel ast.SelectionSet, v *PullRequestState) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
...
func (ec *executionContext) marshalOResourceLoad2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐResourceLoad(ctx context.Context, sel ast.SelectionSet, v *ResourceLoad) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOReviewDecisionEnum2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐReviewDecisionEnum(ctx context.Context, v any) (*ReviewDecisionEnum, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOReviewDecisionEnum2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐReviewDecisionEnum(ctx context.Context, sel ast.SelectionSet, v *ReviewDecisionEnum) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
...
func (ec *executionContext) marshalOTmuxPane2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxPane(ctx context.Context, sel ast.SelectionSet, v *TmuxPane) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._TmuxPane(ctx, sel, v)
...
func (ec *executionContext) unmarshalOTmuxPaneFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxPaneFilter(ctx context.Context, v any) (*TmuxPaneFilter, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOTmuxServer2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxServer(ctx context.Context, sel ast.SelectionSet, v *TmuxServer) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._TmuxServer(ctx, sel, v)
...
func (ec *executionContext) marshalOTmuxSession2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSession(ctx context.Context, sel ast.SelectionSet, v *TmuxSession) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._TmuxSession(ctx, sel, v)
...
func (ec *executionContext) unmarshalOTmuxSessionFilter2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSessionFilter(ctx context.Context, v any) (*TmuxSessionFilter, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) unmarshalOTmuxSessionSort2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSessionSort(ctx context.Context, v any) (*TmuxSessionSort, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOTmuxSessionSort2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxSessionSort(ctx context.Context, sel ast.SelectionSet, v *TmuxSessionSort) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
...
func (ec *executionContext) marshalOTmuxWindow2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐTmuxWindow(ctx context.Context, sel ast.SelectionSet, v *TmuxWindow) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._TmuxWindow(ctx, sel, v)
...
func (ec *executionContext) marshalOWorkflowRun2ᚕᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorkflowRunᚄ(ctx context.Context, sel ast.SelectionSet, v []*WorkflowRun) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNWorkflowRun2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorkflowRun(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalOWorktree2ᚖgithubᚗcomᚋdrewdrewthisᚋgitᚑorchardᚑrsᚋdaemonᚋgraphqlᚐWorktree(ctx context.Context, sel ast.SelectionSet, v *Worktree) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Worktree(ctx, sel, v)
