...
type Conversation struct {
	...
	LiveInstances []*ClaudeInstance `json:"liveInstances"`
}
...
const (
	ClaudeCliToolClaude  ClaudeCliTool = "claude"
	ClaudeCliToolCcusage ClaudeCliTool = "ccusage"
)

var AllClaudeCliTool = []ClaudeCliTool{
	ClaudeCliToolClaude,
	ClaudeCliToolCcusage,
}

func (e ClaudeCliTool) IsValid() bool {
	switch e {
	case ClaudeCliToolClaude, ClaudeCliToolCcusage:
		return true
	}
	return false
}

func (e ClaudeCliTool) String() string {
	return string(e)
}

func (e *ClaudeCliTool) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}
	...
	*e = ClaudeCliTool(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid ClaudeCliTool", str)
	}
	return nil
}

func (e ClaudeCliTool) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *ClaudeCliTool) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e ClaudeCliTool) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
...
const (
	...
	ContractStatusPendingUserApproval              ContractStatus = "PENDING_USER_APPROVAL"
...
var AllContractStatus = []ContractStatus{
	...
	ContractStatusPendingUserApproval,
...
func (e ContractStatus) IsValid() bool {
	switch e {
	case ContractStatusOpen, ContractStatusDeliveredPendingValidation, ContractStatusDeliveredPendingParentValidation, ContractStatusPendingUserApproval, ContractStatusAwaitingCancelAck, ContractStatusWaitingExternal, ContractStatusSatisfied, ContractStatusCancelled, ContractStatusJudgeRejectedTerminal:
		return true
	}
	return false
}
...
var AllPsTool = []PsTool{
	PsToolPs,
	PsToolLsof,
}

func (e PsTool) IsValid() bool {
	switch e {
	case PsToolPs, PsToolLsof:
		return true
	}
	return false
}

func (e PsTool) String() string {
	return string(e)
}

func (e *PsTool) UnmarshalGQL(v any) error {
	str, ok := v.(string)
	if !ok {
		return fmt.Errorf("enums must be strings")
	}
	...
	*e = PsTool(str)
	if !e.IsValid() {
		return fmt.Errorf("%s is not a valid PsTool", str)
	}
	return nil
}

func (e PsTool) MarshalGQL(w io.Writer) {
	fmt.Fprint(w, strconv.Quote(e.String()))
}

func (e *PsTool) UnmarshalJSON(b []byte) error {
	s, err := strconv.Unquote(string(b))
	if err != nil {
		return err
	}
...
func (e PsTool) MarshalJSON() ([]byte, error) {
	var buf bytes.Buffer
	e.MarshalGQL(&buf)
	return buf.Bytes(), nil
}
