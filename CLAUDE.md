...
**Repo constitution: [RULES.md](RULES.md).** 74 numbered rules (L/R/S/O/M/T). Read before any architectural change. Cite rule IDs in PR review (e.g. `R3 violation`). Codified in ADR-023.
