...
**Repo constitution: [RULES.md](RULES.md).** 55 numbered rules (L/R/S/O/M). Read before any architectural change. Cite rule IDs in PR review (e.g. `R3 violation`). Codified in ADR-023.
